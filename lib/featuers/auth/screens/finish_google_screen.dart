...
class FinishGoogleScreen extends ConsumerStatefulWidget {
  const FinishGoogleScreen({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _FinishGoogleScreenState();
}

class _FinishGoogleScreenState extends ConsumerState<FinishGoogleScreen> {
