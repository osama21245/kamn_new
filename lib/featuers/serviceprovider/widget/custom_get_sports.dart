...
import '../../benefits/widget/benefits_home/custom_sports_card.dart';
...
class CustomGetSportsRequests extends ConsumerWidget {
  final String region;
  const CustomGetSportsRequests({super.key, required this.region});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    List<SportsModel> filterList;
    return ref.watch(getSportsRequestProvider).when(
        data: (sports) {
          filterList = sports
