...
class CustomcardPendingSports extends StatelessWidget {
  final Size size;
  final bool fromserviceProviderScreen;
  final QrOrderModel qrorderModel;

  const CustomcardPendingSports({
    super.key,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                        "Price: ${qrorderModel.offerPrice == "Public Offer" ? qrorderModel.offerPrice : "${qrorderModel.offerPrice + " EGP"}"}",
