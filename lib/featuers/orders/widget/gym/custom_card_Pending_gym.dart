...
class CustomcardPendingGym extends StatelessWidget {
  final Size size;
  final bool fromserviceProviderScreen;
  final OrderModel orderModel;

  const CustomcardPendingGym({
    super.key,
          ...
          child: Container(
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.only(bottom: 6.0),
                  child: Text("ExpireDatetime : ${expirationDate}",
                      style: const TextStyle(fontSize: 16)),
                ),
                Padding(
                  padding: const EdgeInsets.only(bottom: 6.0),
                ...
                Row(
                  children: [
                    ...
                    MaterialButton(
                      ...
                      color: Pallete.primaryColor,
                      onPressed: () => Get.to(() => OrderGymDetailsScreen(
