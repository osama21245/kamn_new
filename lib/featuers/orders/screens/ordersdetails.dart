...
import '../widget/order_details/custom_prices_secion.dart';
          ...
          children: [
            ...
            Container(
              ...
              child: ListView(
                children: [
                  CustomPricesSection(
                    discount: orderModel.itemsDiscount,
                    finalprice: orderModel.ordersTotalprice,
                    price: orderModel.ordersPrice,
                  ),
                  const Padding(
                  ...
                  if (!fromserviceProviderScreen)
                    ref
                        .watch(getUserDataProviderr(
                            orderModel.ordersServiceProviderId))
                        .when(
                            data: (userData) =>
                                CustomUserSection(userModel: userData),
                            error: (error, StackTrace) {
