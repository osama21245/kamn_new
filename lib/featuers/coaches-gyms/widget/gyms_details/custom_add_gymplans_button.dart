...
class CustomAddGymPlansButton extends ConsumerStatefulWidget {
  ...
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _CustomAddGymPlansButtonState();
}

class _CustomAddGymPlansButtonState
    extends ConsumerState<CustomAddGymPlansButton> {
  ...
  Widget build(BuildContext context) {
    updatePricesBenefits(
      ...
      ref.watch(coachesGymsControllerProvider.notifier).updatePrices(
          widget.collection,
          widget.gymId,
          widget.gymLocationId,
          prices,
          pricePlan,
          points,
          descriptionPlan,
