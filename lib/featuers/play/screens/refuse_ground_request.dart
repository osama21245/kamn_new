...
class RefuseGroundRequestScreen extends ConsumerStatefulWidget {
  final GroundModel groundModel;
  final String collection;
  const RefuseGroundRequestScreen(
      {super.key, required this.groundModel, required this.collection});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _RefuseGroundRequestScreenState();
}

class _RefuseGroundRequestScreenState
    extends ConsumerState<RefuseGroundRequestScreen> {
  ...
  refuseSports() {
    ...
    if (Formdata!.validate()) {
      ref.watch(playControllerProvider.notifier).deleteGroundRequest(
          widget.groundModel.id, widget.collection, context);

      ref.watch(userControllerProvider.notifier).sendInboxToUser(
          title: "Soory",
          description: reson!.text,
          imageFile: attachImage,
          userId: widget.groundModel.groundOwnerId,
