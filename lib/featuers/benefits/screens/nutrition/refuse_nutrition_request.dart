...
class RefuseNutritionRequestScreen extends ConsumerStatefulWidget {
  final NutritionModel nutritionModel;
  const RefuseNutritionRequestScreen({super.key, required this.nutritionModel});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _RefuseNutritionRequestScreenState();
}

class _RefuseNutritionRequestScreenState
    extends ConsumerState<RefuseNutritionRequestScreen> {
