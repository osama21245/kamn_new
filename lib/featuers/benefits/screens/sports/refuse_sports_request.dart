...
class RefuseSportsRequestScreen extends ConsumerStatefulWidget {
  final SportsModel sportsModel;
  const RefuseSportsRequestScreen({super.key, required this.sportsModel});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _RefuseSportsRequestScreenState();
}

class _RefuseSportsRequestScreenState
    extends ConsumerState<RefuseSportsRequestScreen> {
